...
namespace BankAccount
{
    public class Bank
    {
        ...
        public void Deposit(double amount, Account account)
        {
            ...
            //var accountList = Newtonsoft.Json.JsonConvert.SerializeObject(account);
            //System.IO.File.WriteAllText(@"C:\Work\Training\DotNet\BankAccount\BankAccount\Data\Accounts.json", accountList);
        }
